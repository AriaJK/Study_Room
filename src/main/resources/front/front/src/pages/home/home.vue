...
<div class="home-preview" :style='{"width":"100%","margin":"10px 0","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
	<el-row type="flex" :gutter="5" justify="center" style="width: 100%">
		...
		<el-col :span="3" v-if="queryIndex==0">
			<el-input v-model="zixishimingcheng" placeholder="名称"></el-input>
		</el-col>
		<el-col :span="3" v-if="queryIndex==0">
			<el-button type="primary" @click="search('zixishi')">搜索</el-button>
		</el-col>
	</el-row>
...
<div class="news" :style='{"border":"2px solid #347BEF","padding":"20px 10px 40px","margin":"50px auto","background":"#fff","width":"40%","position":"relative","height":"auto"}'>
	...
	<div class="title" :style='{"width":"200px","margin":"10px auto","lineHeight":"54px","textAlign":"center"}'>
		<span :style='{"color":"#000","fontSize":"28px"}'>公告资讯</span>
	</div>
...
<div class="lists" :style='{"border":"2px solid #347BEF","padding":"20px 10px 50px","margin":"50px auto","background":"#fff","width":"40%","position":"relative","height":"auto"}'>
	...
	<div class="title" :style='{"width":"200px","margin":"10px auto","lineHeight":"54px","textAlign":"center"}'>
	  <span :style='{"color":"#000","fontSize":"28px"}'>自习室展示</span>
	</div>
	...
	<div class="list list2 index-pv1" :style='{"padding":"0 10px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-around","height":"auto"}'>
		<div :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","padding":"20px 0 0 0","margin":"10px 0","background":"#ffff","display":"flex","width":"45%","fontSize":"0","position":"relative","height":"250px"}' v-for="(item,index) in zixishiList" class="list-item animation-box" :key="index" @click="toDetail('zixishiDetail', item)">
			...
			<div :style='{"padding":"10px","overflow":"hidden","flex":"1","display":"inline-block","height":"250px"}' class="item-info">
				<div class="name line1" :style='{"lineHeight":"30px","fontSize":"14px","overflow":"hidden","color":"#000000","height":"30px"}'>{{item.mingcheng}}</div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('zixishi')" :style='{"border":"0","margin":"10px auto","transform":"translateX(-50%)","textAlign":"center","left":"50%","background":"#347bef","bottom":"-10px","display":"block","width":"200px","lineHeight":"32px","position":"absolute"}'>
		<span :style='{"color":"#f5f5f5","fontSize":"12px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#f5f5f5","fontSize":"12px"}' class="el-icon-d-arrow-right"></i>
	</div>
