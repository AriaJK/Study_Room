	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="签到时间" prop="qiandaoshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.qiandaoshijian" label="签到时间" prop="qiandaoshijian">
					<el-input v-model="ruleForm.qiandaoshijian" placeholder="签到时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.renlianshibie" label="人脸识别" prop="renlianshibie">
					<file-upload
						tip="点击上传人脸识别"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.renlianshibie" label="人脸识别" prop="renlianshibie">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.renlianshibie.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="签到备注" prop="qiandaobeizhu">
					<el-input v-model="ruleForm.qiandaobeizhu" placeholder="签到备注" clearable  :readonly="ro.qiandaobeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="签到备注" prop="qiandaobeizhu">
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0"}' class="btn">
				<el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#93C7B3","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-show="!faceMatchFlag" v-if="type!='info'" type="primary" class="btn-success" @click="faceMatchHandle">人脸校验</el-button>
				<el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#93C7B3","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-show="faceMatchFlag" v-if="type!='info'" type="primary" class="btn-success" @click="onSubmit">提交</el-button>
...
export default {
    ...
    faceMatchHandle() {
        if(this.ruleForm.renlianshibie!=null) {
            this.ruleForm.renlianshibie = this.ruleForm.renlianshibie.replace(new RegExp(this.$base.url,"g"),"");
        }
            let params = {
