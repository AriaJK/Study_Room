			...
			<el-form class="center-form-pv" :style='{"width":"250px","padding":"0 6px","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"flexDirection":"column","display":"flex"}' >
					<div :style='{"margin":"0","flexDirection":"column","display":"flex"}'>
						<label :style='{"margin":"0","color":"#000","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">预约单号</label>
						<el-input v-model="searchForm.yuyuedanhao" placeholder="预约单号" clearable></el-input>
					</div>
					<div :style='{"margin":"0","flexDirection":"column","display":"flex"}' class="select" label="签到状态" prop="qiandaozhuangtai">
						<label :style='{"margin":"0","color":"#000","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">签到状态</label>
						<el-select  @change="qiandaozhuangtaiChange" clearable v-model="searchForm.qiandaozhuangtai" placeholder="请选择签到状态">
							<el-option v-for="(item,index) in qiandaozhuangtaiOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#93C7B3","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('yuyuexinxi','取消预约')" type="success" size="mini" @click="quxiaoyuyueCrossAddOrUpdateHandler(scope.row,'cross','是','[1]','请勿重复操作！')">取消预约</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#93C7B3","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('yuyuexinxi','签到')" type="success" size="mini" @click="qiandaoxinxiCrossAddOrUpdateHandler(scope.row,'cross','是','qiandaozhuangtai','请勿重复签到！','已签到,未签到'.split(',')[0])">签到</el-button>
      ...
      let params = {
        ...
        order: 'desc',
          ...
          if(this.searchForm.sfsh!='' && this.searchForm.sfsh!=undefined){
           ...
           if(this.searchForm.qiandaozhuangtai!='' && this.searchForm.qiandaozhuangtai!=undefined){
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          tupian: row.tupian,
          zuowei: row.zuowei,
          qiandaozhuangtai: row.qiandaozhuangtai,
