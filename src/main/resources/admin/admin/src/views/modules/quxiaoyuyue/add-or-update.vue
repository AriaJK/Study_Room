<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="预约单号" prop="yuyuedanhao">
					<el-input v-model="ruleForm.yuyuedanhao" placeholder="预约单号" clearable  :readonly="ro.yuyuedanhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="预约单号" prop="yuyuedanhao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="取消原因" prop="quxiaoyuanyin">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.quxiaoyuanyin" label="取消原因" prop="quxiaoyuanyin">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.quxiaoyuanyin}}</span>
				</el-form-item>
