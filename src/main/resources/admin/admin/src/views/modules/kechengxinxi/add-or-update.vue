	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.kechengziyuan" label="课程资源" prop="kechengziyuan">
					<file-upload
						tip="点击上传课程资源"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.kechengziyuan" label="课程资源" prop="kechengziyuan">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#93C7B3","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.kechengziyuan)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.kechengziyuan" label="课程资源" prop="kechengziyuan">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.kechengjieshao = this.ruleForm.kechengjieshao.replace(reg,'../../../study_room/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.kechengziyuan!=null) {
		this.ruleForm.kechengziyuan = this.ruleForm.kechengziyuan.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    kechengziyuanUploadChange(fileUrls) {
	    this.ruleForm.kechengziyuan = fileUrls;
    },
  }
};
</script>
